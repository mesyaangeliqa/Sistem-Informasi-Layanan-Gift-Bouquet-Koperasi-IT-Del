            ...
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">{{ $product }}</span>
                        <div class="m-0">
                            <span class="fw-bold fs-6 text-gray-400">Jumlah Produk</span>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-xl-10">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">{{ $order }}</span>
                        <div class="m-0">
                            <span class="fw-bold fs-6 text-gray-400">Jumlah Orders</span>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-xl-10">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">{{$critic}}</span>
                        <div class="m-0">
                            <span class="fw-bold fs-6 text-gray-400">Jumlah Kritik dan saran</span>
                        </div>
                    </div>
        ...
        <div class="col-sm-6 col-xl-3 mb-xl-10">
            <div class="card h-lg-100">
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <span class="fw-bold fs-3x text-gray-800 lh-1 ls-n2">{{$user}}</span>
                        <div class="m-0">
                            <span class="fw-bold fs-6 text-gray-400">Jumlah Pengguna</span>
                        </div>
                    </div>
            ...
            <div class="card" style="background: #1C325E;">
                <div class="card-body d-flex ps-xl-15">
                    <div class="m-0">
                        ...
                        <span class="me-2">Selamat Datang Admin!! <br> 
                        <span class="position-relative d-inline-block text-danger">
                            <a href="{{ route('home') }}" class="text-danger opacity-75-hover">Lihat Aplikasi</a>
                            <span class="position-absolute opacity-50 bottom-0 start-0 border-4 border-danger border-bottom w-100"></span>
                        </span></span>Anda.
                        <br />Silahkan Mengelola Bouquet Anda</div>
                        <div class="mb-3">
                            <a href='{{ route('admin.productcategory.index') }}' class="btn btn-danger fw-bold me-2">Add Produk Kategori</a>
                            <a href='{{ route('admin.product.index') }}' class="btn btn-danger fw-bold me-2">Add Produk</a>
                            <a href='{{ route('admin.order.index') }}' class="btn btn-danger fw-bold me-2">Order</a>
                        </div>
                    </div>
