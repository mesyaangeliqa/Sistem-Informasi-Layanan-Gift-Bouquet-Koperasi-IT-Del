            ...
            <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
                ...
                <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="key_meta" class="form-control mb-2" placeholder="Masukkan Jabatan Anda" value="{{ $data->key_meta }}" />
                                        </div>
                                    </div>
                                    <div class="card-body pt-0">
                                        <div class="mb-10 fv-row">
                                            <label class="required form-label">Nama</label>
                                            <input type="text" name="name" class="form-control mb-2" placeholder="Masukkan Nama Anda" value="{{ $data->name }}" />
                                        </div>
                                    </div>
                                    <div class="card-body pt-0">
                                        <div class="mb-10 fv-row">
                                            <label class="required form-label">Photo</label>
                                            <input type="file" name="image" accept=".png,.jpg,.jpeg" class="form-control mb-2" placeholder="Masukkan Gambar Anda" value="{{ $data->image }}" />
                                        </div>
                                    </div>
                                    <div class="card-body pt-0">
                                        <div class="mb-10 fv-row">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        @if ($data->id)
                        <button type="submit" id="kt_ecommerce_add_product_submit"  onclick="handle_upload('#kt_ecommerce_add_product_submit','#kt_ecommerce_add_product_form','{{route('admin.webprofile.update',$data->id)}}','PATCH');" class="btn btn-primary">
                        ...
                        @else
                            <button type="submit" id="kt_ecommerce_add_product_submit"  onclick="handle_upload('#kt_ecommerce_add_product_submit','#kt_ecommerce_add_product_form','{{route('admin.webprofile.store')}}','POST');" class="btn btn-primary">
                                <span class="indicator-label">Save Changes</span>
                                <span class="indicator-progress">Please wait...
                                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                                </span>
